...
const getFollwingPeopleIdsOfUser=async(username)=>{
...
app.get("/user/tweets/feed/",authentication,async (request,response)=>{
    ...
    const followingPeopleIds=await getFollwingPeopleIdsOfUser(username);
    const getTweetQuery=`SELECT 
...
app.get("/user/tweets/",authentication,async (request,response)=>{
    ...
    const getTweetQuery=`
        ...
        cCOUNT (DISTINCT reply_id) AS replies,
        date_time AS dateTime
